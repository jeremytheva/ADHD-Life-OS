...
const conversionByItemId = new Map()
...
export const inboxService = {
  ...
  convertToTask(itemId) {
    const existingConversion = conversionByItemId.get(itemId)
    ...
    const conversion = Promise.resolve()
      ...
      .finally(() => {
        conversionByItemId.delete(itemId)
      })

    conversionByItemId.set(itemId, conversion)
    return conversion
  }
}

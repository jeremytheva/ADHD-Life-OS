      ...
      <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg border border-purple-200 p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            `}
          >
            <SafeIcon icon={FiSliders} className="w-5 h-5" aria-hidden="true" />
          </button>
        </div>
      ...
      {recommendations.length > 0 ? (
                ...
                <div className={`bg-gradient-to-r ${getPathColor(rec.path)} px-4 py-2`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-white">
                      <SafeIcon icon={getPathIcon(rec.path)} className="w-4 h-4" aria-hidden="true" />
                      <span className="text-sm font-medium">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-3">
                    ...
                    {rec.task.priority_metadata?.energy_required && (
                      <span className="px-2 py-1 bg-green-50 text-green-700 rounded text-xs flex items-center gap-1">
                        <SafeIcon icon={FiZap} className="w-3 h-3" aria-hidden="true" />
                    ...
                    {rec.task.priority_metadata?.location && (
                      <span className="px-2 py-1 bg-purple-50 text-purple-700 rounded text-xs flex items-center gap-1">
                        <SafeIcon icon={FiMapPin} className="w-3 h-3" aria-hidden="true" />
                        {rec.task.priority_metadata.location}
                      </span>
                    )}
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-12 text-center">
          <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <SafeIcon icon={FiTarget} className="w-8 h-8 text-purple-600" aria-hidden="true" />
          </div>
